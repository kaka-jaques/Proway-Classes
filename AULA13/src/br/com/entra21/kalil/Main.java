...
public class Main {
	...
	public static String escreverMenu() {
		...
		menu += "\t4 - Criar matriz de quantos vetores e detalhes , conforme o desejo do usuário";
		return menu;
	}
	...
	public static void criarMatriz2Niveis() {
		...
		System.out.println(
				"matrizShort tamanho = " + matrizShort.length + " e cada vetor tem tamanho +" + matrizShort[0].length);
		System.out.println(
				"matrizInt tamanho = " + matrizChars.length + " e cada vetor tem tamanho +" + matrizInt[0].length);
		System.out.println(
	...
	public static void initializeMatrizTwoLevel() {
		// Criar matrizes de 2 níveis inicializados para cada tipo primitivo e exibir o
		// tamanho deles no console
		...
		byte matrizBytes[][] = { // Irregular porque tem capacidades de index diferentes por vetor
				{ 1, 20, 3, 40, 5 }, { 20, 3, 40, 5 }, { 3, 45 }, { 120 }, };

		short matrizShorts[][] = { { 300, 400, 1200 }, { 500, 600, 100 }, { 1000, 4000, 5000 }, };

		int matrizInts[][] = { { 3100 }, { 5030 }, { 10000 }, };

		long matrizLongs[][] = { { 300, 400, 500, 600 }, { 1000000, 5000000, 300 }, { 10000, 10000 }, };

		float matrizFloats[][] = { { 30.0f, 40.5f, 5.6f, 6.1f }, { 10.7f, 53.f, 31.4f }, { 11.f, 14.3f }, };

		double matrizDoubles[][] = { { 310.0f, 420.5f, 53.6f, 62.1f }, { 102.7f, 543.f, 321.4f },
				{ 1134.f, 1434.3f }, };

		
		
		/*
		 * for (byte vetor = 0; vetor < matrizChars.length; vetor++) { for (byte detail
		 * = 0; detail < matrizChars[vetor].length; vetor++) {
